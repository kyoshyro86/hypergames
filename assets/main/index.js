...
System.register("chunks:///_virtual/BoardController.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Utils2.ts', './BlockDragControl.ts', './Block.ts', './BlockPuzzleScene.ts'], function (exports) {
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './telegram-web.ts', './AudioController.ts', './CanvasHelpper.ts', './ResizeWindowHelper.ts', './BasePopup.ts', './PopupAnimation.ts', './PopupController.ts', './PortalController.ts', './BaseScene.ts', './SceneController.ts', './LoadingGameScene.ts', './ActionHelper.ts', './ActionHelpper.ts', './Utilities.ts', './utils.ts', './BlockPuzzleScene.ts', './GameClosePopup.ts', './GameWinPopup.ts', './PromptPopup.ts', './AudioManager.ts', './Block.ts', './BlockDrag.ts', './BlockDragControl.ts', './BoardController.ts', './BlockData.ts', './User.ts', './PageBlock.ts', './SpineController.ts', './Utils2.ts', './Config.ts', './Events.ts', './GlobalEvent.ts', './LogManager.ts', './WalletController.ts', './WalletView.ts'], function () {
  return {
...
System.register("chunks:///_virtual/User.ts", ['cc', './Utils2.ts'], function (exports) {
